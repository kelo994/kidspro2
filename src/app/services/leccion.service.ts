...
export class LeccionService {
    ...
    getBloque(idCurso: any, idAsignatura: any, idBloque: any) {
        return this.http.get(`${this.url}/detalleBloque/${idCurso}/${idAsignatura}/${idBloque}`, this.getToken());
    }


    getBloquesActivos(idCurso, idAsignatura) {
